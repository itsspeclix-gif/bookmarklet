(function() {
var BASE = 'https://santa--019d70d27d9b77ad8f915a09dbe7c498.web.val.run';
...
try { frame.contentWindow.postMessage({ type: 'HUDDLE_TOKEN', token: savedToken }, '*'); } catch (e) {}
});
window.addEventListener('message', function(e) {
if (e.data && e.data.type === 'HUDDLE_SAVE_TOKEN') { localStorage.setItem(STORE_KEY, e.data.token || ''); savedToken = e.data.token || ''; }
if (e.data && e.data.type === 'HUDDLE_LOGOUT') { localStorage.removeItem(STORE_KEY); savedToken = ''; }
});
