javascript:(async function _main() {
    ...
    function loadLibrary(games, userName, startTime) {
        ...
        function updPanel(){
            ...
            document.getElementById('pFavs').innerHTML=fv.length?fv.map(function(n){return '<div style="padding:9px 12px;background:var(--s2);border-radius:10px;margin-bottom:6px;font-size:13px;font-weight:500;display:flex;align-items:center;gap:8px;"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 7v10"/><path d="M9 7v10"/><path d="M18 12h-3"/><path d="M6 12h3"/><path d="M21 12a9 9 0 0 1-9 9 9 9 0 0 1-9-9 9 9 0 0 1 9-9 9 9 0 0 1 9 9z"/></svg> '+n+'</div>';}).join(''):'<div style="color:var(--t2);font-size:13px;">No favorites yet</div>';
        ...
        function mkCard(name,gd,container){var c=document.createElement('div');c.className='card';c.dataset.name=name;var ic=gd.icon;c.innerHTML='<div class="ib">'+(ic?'<img src="https://drive.google.com/uc?export=view&id='+ic+'" onload="this.style.opacity=1">':'')+'<div class="play"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="#fff"><polygon points="8,5 8,19 19,12"/></svg></div></div><div class="cn">'+name+'</div>';c.onclick=function(){launchGame(name,gd);};container.appendChild(c);}
